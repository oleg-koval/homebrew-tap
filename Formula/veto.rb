...
class Veto < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      define_method(:install) do
        bin.install "veto_0.1.0_darwin_amd64/veto" => "veto"
      end
    end
    ...
    if Hardware::CPU.arm?
      ...
      define_method(:install) do
        bin.install "veto_0.1.0_darwin_arm64/veto" => "veto"
      end
    end
  end
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      ...
      define_method(:install) do
        bin.install "veto_0.1.0_linux_amd64/veto" => "veto"
      end
    end
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      define_method(:install) do
        bin.install "veto_0.1.0_linux_arm64/veto" => "veto"
      end
    end
  end
